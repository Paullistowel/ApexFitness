  ...
  return (
    <div className="min-h-screen bg-[#1a0f08]">
      ...
      <section className="relative pt-36 pb-20 overflow-hidden">
        ...
        />
        {/* glow blob */}
        <div className="absolute -top-24 left-1/2 -translate-x-1/2 w-[600px] h-[400px] bg-orange-600/20 rounded-full blur-[120px] pointer-events-none" />
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.span
            ...
            animate="visible"
            custom={0}
            className="inline-block text-orange-500 font-semibold text-sm uppercase tracking-widest mb-4"
          >
            Get In Touch
          </motion.span>
          <motion.h1
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-24">
        <div className="grid lg:grid-cols-5 gap-8 items-start">
          {/* Form */}
          <motion.div
            className="lg:col-span-3 rounded-2xl bg-white/5 border border-white/5 p-8 sm:p-10"
            ...
            {submitted ? (
              <div className="flex flex-col items-center justify-center py-16 gap-4 text-center">
                ...
                <button
                  ...
                  className="mt-4 text-orange-500 hover:text-orange-400 text-sm font-medium underline underline-offset-4 transition-colors"
                >
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="grid sm:grid-cols-2 gap-5">
                    <div className="flex flex-col gap-1.5">
                      ...
                      <input
                        ...
                        className="bg-white/5 border border-white/10 focus:border-orange-500/60 outline-none rounded-xl px-4 py-3 text-white placeholder-gray-600 text-sm transition-colors"
                      />
                    </div>
                    <div className="flex flex-col gap-1.5">
                      <label className="text-gray-400 text-sm font-medium">
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <textarea
                      ...
                      className="bg-white/5 border border-white/10 focus:border-orange-500/60 outline-none rounded-xl px-4 py-3 text-white placeholder-gray-600 text-sm transition-colors resize-none"
                    />
                  </div>
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-orange-500 to-orange-700 hover:from-orange-600 hover:to-orange-800 disabled:opacity-60 text-white px-8 py-4 rounded-xl font-semibold transition-all duration-300 hover:shadow-lg hover:shadow-orange-500/25"
                  >
                    {loading ? (
          ...
          >
            {/* Map embed */}
            <div className="rounded-2xl overflow-hidden border border-white/5 h-56 sm:h-72">
              <iframe
            ...
            {/* Social / extra info */}
            <div className="rounded-2xl bg-white/5 border border-white/5 p-6 flex flex-col gap-5">
              <div>
              ...
              <div className="flex gap-3">
                {socialLinks.map((s) => (
                  <a
                    ...
                    href={s.href}
                    aria-label={s.label}
                    className="w-10 h-10 rounded-full bg-white/5 hover:bg-orange-600 border border-white/5 hover:border-orange-600 flex items-center justify-center transition-all duration-300 group"
                  >
