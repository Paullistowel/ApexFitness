...
export default function AuthPage() {
  return (
    <main className="h-screen bg-[#1a0f08] md:p-7">
      <section className="relative mx-auto flex h-full max-w-[1600px] overflow-hidden bg-[#1d1a17] shadow-[0_25px_80px_rgba(0,0,0,0.28)] rounded-3xl">
        ...
        {/* ── Right: Auth form ── */}
        <div className="relative flex w-full md:max-w-[430px] lg:max-w-[470px] bg-[#1a0f08]">
          {/* angled join edge — outside scroll container so overflow-y-auto doesn't clip it */}
          <div className="absolute inset-y-0 -left-20 hidden w-40 skew-x-[-12deg] bg-[#1a0f08] md:block z-10" />
