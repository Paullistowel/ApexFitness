    ...
    <div className="relative" ref={menuRef}>
      ...
      >
        ...
        <div className="hidden sm:block text-left">
          <p className="text-sm font-semibold text-foreground leading-none">Emmanuel</p>
          <p className="text-[10px] text-muted mt-0.5">Pro Member</p>
        </div>
        <ChevronDown
          size={13}
      ...
      {/* Dropdown panel — matches onboarding SelectContent style */}
      {open && (
          ...
          <div className="px-4 py-3 border-b border-border/10">
            <div className="flex items-center gap-2.5">
              ...
              <div className="min-w-0">
                <p className="text-sm font-bold text-foreground truncate">Emmanuel Acquah</p>
                <p className="text-[10px] text-primary font-semibold">Pro Member</p>
              </div>
            </div>
          </div>
